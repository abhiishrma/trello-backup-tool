...
$application_token = 'YOUR APPLICATION KEY';
...
foreach ($boards as $id => $board) {
    ...
    if (empty($decoded)) {
        ...
        // Save Board Details in database
        $cards = $decoded->cards;
        foreach($cards as $card){
            ...
            $cardDesc = $card->desc;
            $cardDesc = str_replace("'","\'", $cardDesc); 
            $sql = "INSERT INTO trello (boardID, listID, cardID, card_title, card_description) VALUES ('$boardID', '$listID', '$cardID', '$cardTitle', '$cardDesc')";
